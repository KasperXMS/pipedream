...
from model_zoo import AlexNet, resnet18
import torch
...
from pytorch_llama.inference import LLaMA
...
if __name__ == '__main__':
    model = LLaMA.build(
        checkpoints_dir='profiler/pytorch_llama/llama-2-7b',
        tokenizer_path='profiler/pytorch_llama/tokenizer.model',
        load_model=False,
        max_seq_len=1024,
        max_batch_size=train_dataset_len,
        device='cuda'
    )
    main(model, 'llama')
